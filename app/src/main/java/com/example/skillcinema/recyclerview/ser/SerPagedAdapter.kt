package com.example.skillcinema.recyclerview.ser
...
class SerPagedAdapter (val onClick: (FilmsSerDramDet) -> Unit) : PagingDataAdapter<FilmsSerDramDet, MovieViewHolder>(DiffUtilCallback()) {
