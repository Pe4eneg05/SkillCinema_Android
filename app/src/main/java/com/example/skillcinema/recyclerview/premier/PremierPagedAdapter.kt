...
//class PremierPagedAdapter (val onClick: (FilmsPremier) -> Unit) : PagingDataAdapter<FilmsPremier, MovieViewHolder>(DiffUtilCallback()) {
//
...
//}
//
//class DiffUtilCallback : DiffUtil.ItemCallback<FilmsPremier>() {
//    override fun areItemsTheSame(oldItem: FilmsPremier, newItem: FilmsPremier): Boolean =
//        oldItem.kinopoiskId == newItem.kinopoiskId
//
//    override fun areContentsTheSame(oldItem: FilmsPremier, newItem: FilmsPremier): Boolean = oldItem == newItem
//}
