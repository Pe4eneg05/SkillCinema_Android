...
class TopAdapter (val onClick: (FilmsTopPopular) -> Unit) : RecyclerView.Adapter<MovieViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MovieViewHolder, position: Int) {
        ...
        with(holder.binding){
            ...
            if (item?.rating == null || item.rating.toString() == "") textRating.isVisible = false
            else textRating.text = item.rating.toString()
            item?.let {
